...
<template>
  <div class="space-y-1.5 flex flex-col flex-1">
    ...
    <div class="relative flex-1 flex">
      ...
      <input
        ...
        :class="cn(
          'flex-1 w-full min-h-11 rounded-lg border bg-card px-3 text-sm text-foreground placeholder:text-muted-foreground/70',
          hasLeft && 'pl-10',
          hasRight && 'pr-10',
