...
<template>
    <Dialog 
        ...
        :title="t('forms.enableFormTitle')"
        :description="t('forms.enableFormDescription')"
        width="md"
    >
        <!-- Form Preview -->
        ...
        <div class="flex gap-3 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-600 dark:text-amber-500">
            ...
            <div class="flex-1 text-sm">
                <p class="font-medium mb-1">{{ t('forms.enableWarningTitle') }}</p>
                <p class="text-xs opacity-90">{{ t('forms.enableWarningDescription') }}</p>
            </div>
        </div>
