...
export const en = {
  ...
  bots: {
    ...
    editor: {
      ...
      textHint: 'The persona is the bot’s core voice and is required.',
      ...
      taskExecutionEnabledLabel: 'Enable task execution',
      taskExecutionDisabledInfo: 'When enabled, this bot can be assigned tasks and will run them using the tools you grant below.',
      toolsLabel: 'Tools',
      toolsHint: 'Choose which tools this bot may use while running tasks.',
      toolsPlaceholder: 'Select tools',
      knowledgeEnabledLabel: 'Enable knowledge',
      knowledgeDisabledInfo: 'When enabled, these knowledge entries are given to the bot as context while it works.',
      knowledge: {
