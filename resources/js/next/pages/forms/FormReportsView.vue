...
<template>
  <div class="flex flex-col gap-next-5">
    <div class="flex flex-wrap items-center justify-between gap-next-3">
      <div class="min-w-0">
        <h1 class="truncate text-next-xl font-next-semibold text-next-fg">{{ t('forms.reports.title') }}</h1>
        <p class="text-next-sm text-next-muted-foreground">{{ t('forms.reports.subtitle') }}</p>
      </div>
