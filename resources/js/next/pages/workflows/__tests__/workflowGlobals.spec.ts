// Unit tests for the PURE globals authoring model (Phase 3): the draft ⇆ descriptor
// mapping, the CLIENT mirror of WorkflowGlobalTypeValidator (value-vs-descriptor), the
// key slug + safety rules, and the list summaries. No DOM — pure functions only.
...
import {
  ...
  valuePreview,
  newTypeDraft,
  type GlobalTypeDraft,
} from '../workflowGlobals';

beforeEach(() => setLocale('en'));

/** Build a type draft over the defaults. */
function draft(overrides: Partial<GlobalTypeDraft> = {}): GlobalTypeDraft {
